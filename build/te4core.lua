...
project "TEngine"
	...
	buildoptions { "-O3", "-Wno-incompatible-pointer-types" }
...
if _OPTIONS.lua == "default" then
	project "luadefault"
		...
		language "C"
		targetname "lua"
		buildoptions{ "-O2", "-Wno-incompatible-pointer-types" }
...
elseif _OPTIONS.lua == "jit2" then
	project "minilua"
		...
		elseif string.find(arch_test, "LJ_TARGET_X86") then
			target_arch = "x86"
		elseif string.find(arch_test, "LJ_TARGET_ARM64") then
			target_arch = "arm64"
		...
		configuration {"Debug"}
			if _OPTIONS.wincross then
				postbuildcommands {
					'gcc -MMD -MP -DGLEW_STATIC -DLUAJIT_TARGET=LUAJIT_ARCH_x86 -DLJ_ARCH_HASFPU=1 -DLJ_ABI_SOFTFP=0 -I../src -I../src/luasocket -I../src/fov -I../src/expat -I../src/lxp -I../src/libtcod_import -Wno-incompatible-pointer-types -I../src/physfs -I../src/zlib -I../src/bzip2 -I../src/luajit2/src -I../src/luajit2/dynasm -g -m32 -ggdb -o "../obj/Debug/minilua/minilua.cross.o" -c "../src/luajit2/src/host/minilua.c"',
